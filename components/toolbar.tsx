...
export const Toolbar = ({ initialData, preview }: ToolbarProps) => {
  ...
  return (
    <div className="pl-[54px] group relative">
      {!!initialData.icon && !preview && (
        <div className="flex items-center gap-x-2 group/icon pt-6">
          ...
          <Button
            ...
            className="rounded-full opacity-100 md:opacity-0 md:group-hover/icon:opacity-100 transition text-muted-foreground text-xs"
            variant="outline"
            size="icon"
          >
            <X className="h-4 w-4" />
      ...
      <div className="opacity-100 md:opacity-0 md:group-hover:opacity-100 flex items-center gap-x-1 py-4">
        {!initialData.icon && !preview && (
        ...
        {!initialData.coverImage && !initialData.tempCoverImage && !preview && (
